...
## Notes
Please use the STLs for printing.  The CAD/STEP files are available in the event modifications are necessary for certain setups, but some print services cannot import STEP files and certain CAD files have been uploaded as assemblies and will not print properly if directly imported into print services.
